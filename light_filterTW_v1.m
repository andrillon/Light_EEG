...
List_Subj=dir([data_path filesep 'TW_all_CIfre_ft_*.mat']);
...
for nS=1:length(List_Subj)
    ...
    paramSW.LimFrqW=[4 10]; % Freq range you want to select: [1 4] or [4 10] in Hz
    ...
    save([data_path filesep 'TW_90P2PbyE_baseline_' File_Name2(1:end-4)],'slow_Waves','labels','Fs','paramSW');
